...
public class Lang {
	...
	public static class Items {
		...
		public static class JoinItems {
			...
			public List<String> ParticleSelector_Lore = new ArrayList<>() {{
			...
			public List<String> GadgetSelector_Lore = new ArrayList<>() {{
